...
# Table name: users
#
#  id                          :bigint(8)        not null, primary key, indexed => [encrypted_email, encrypted_email_iv]
#  email_bidx                  :string           indexed
...
class User < ApplicationRecord
  ...
  validate :case_insensitive_email_uniqueness
  ...
  # But, since that doesn't seem to work with blind indexes, doing it this way:
  def case_insensitive_email_uniqueness
